...
### 🍽️ Belly App  
**Restaurant table management system** developed as a Minimum Viable Product for social service.  
Focused on real usage, CRUD operations, and core business logic.

### 📦 QR Reader  
**Mobile inventory management application** using QR codes and barcodes.  
Developed as part of a mobile application development course.

### 🌐 OrdinarioWeb  
**Full-stack web application** developed for a web development course, including frontend, backend, and database integration.
...
- Any tech stack — I adapt fast and learn on the job

---

## 📫 Contact

📧 **Email:** ortegaaguilarelias@gmail.com  

<p align="left">
<a href="https://www.linkedin.com/in/el%C3%ADas-ortega-aguilar-b20a5427a/" target="_blank">
...
> If you’re looking for someone eager to learn, adapt, and work hard — let’s connect.
